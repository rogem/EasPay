...
//                                .setQuery(FirebaseDatabase.getInstance().getReference().child("History").child(key), HistoryModel.class)
//                                .build();
//                        historyRecyclerAdapter = new HistoryRecyclerAdapter(options);
//                        recyclerView = findViewById(R.id.historyRecyclerView);
//
//                        recyclerView.setAdapter(historyRecyclerAdapter);
//                        DividerItemDecoration dividerItemDecoration = new DividerItemDecoration(TransactionHistory.this, DividerItemDecoration.VERTICAL);
